...
public class Test210 {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        FileWriter writer = new FileWriter("TestCaseResults_Full.txt");

        int totalTestCaseNo = 1; // số thứ tự test case toàn bộ 9 chức năng

        // Chạy tất cả 9 chức năng
        for (int fn = 1; fn <= 9; fn++) {
            ...
            for (WebElement row : rows) {
                // Lấy lại cells mỗi dòng trong vòng lặp để tránh lỗi StaleElementReferenceException
                ...
                String line = totalTestCaseNo + " | " + a + " | " + b + " | " + c + " | " + d + " | " + expected + " | " + actual + " | " + status;
                writer.write(line + "\n");
        ...
        writer.close();
        driver.quit();
        System.out.println("Da luu ket qua vao file TestCaseResults_Full.txt");
        System.out.println("Tong cong 9 chuc nang, 630 test case da duoc luu.");
    }
}
